...
class NetflixPage extends StatefulWidget {
  @override
  netflix createState() => netflix();
}

class netflix extends State<NetflixPage> {
  ...
  List<String> genresNetflix = [...genresN];
  bool reinicio = false;
  ...
  Future<void> cargarDatos() async {
    final String datos = await rootBundle.loadString('assets/netflix.csv');
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Expanded(
                       child: genreImagesN.containsKey(genre)
                          ? Image.asset(
                              genreImagesN[genre]!,
                              fit: BoxFit.cover,
                            )
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                    children: [
                      ...
                      SizedBox(height: 0),
                        Text(
                          '"Servicio de transmisión o `streaming` que permite ver una gran variedad de series, documentales y películas en cualquier dispositivo con acceso a internet como celulares, computadoras, tabletas o `smart tv` mediante el pago de una tarifa fija mensual."',
                          style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: genresNetflix.length,
                  itemBuilder: (context, index) {
                    final genre = genresNetflix[index];
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                final String appLink = 'https://easylist.com/netflix';
