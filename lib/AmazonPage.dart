...
class AmazonPage extends StatefulWidget {
  @override
  amazon createState() => amazon();
}

class amazon extends State<AmazonPage> {
  ...
  List<String> genresAmazon = [...genresA];
  bool reinicio = false;
  ...
  Future<void> cargarDatos() async {
    final String datos = await rootBundle.loadString('assets/amazon.csv');
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Expanded(
                       child: genreImagesA.containsKey(genre)
                          ? Image.asset(
                              genreImagesA[genre]!,
                              fit: BoxFit.cover,
                            )
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: genresAmazon.length,
                  itemBuilder: (context, index) {
                    final genre = genresAmazon[index];
